...
public class ApplicationBuilder : IDesignTimeApplicationFactory {
    public static WinApplication BuildApplication() {
        ...
        builder.UseApplication<CS403_SKWindowsFormsApplication>();
        builder.Modules
    ...
    XafApplication IDesignTimeApplicationFactory.Create() {
        DevExpress.ExpressApp.Security.ClientServer.MiddleTierClientSecurity.DesignModeUserType = typeof(CS403_SK.Module.BusinessObjects.ApplicationUser);
